...
public interface StudentRepository extends SrpRepository<Student, String> {
    ...
    @Query(value = "update student set group_division =:groupDivision, student_code =:studentCode where user_name =:userName", nativeQuery = true)
    public int updateBatchGroupCode(@Param("userName") String userName, 
        @Param("groupDivision") String groupDivision , @Param("studentCode") String studentCode);
